            ...
            <div className="w-full py-8">
                                    ...
                                    <div className="flex items-center">
                                        ...
                                        <div className="w-2/3 text-gray-800 dark:text-gray-200">
                                            <div className="flex flex-wrap gap-2">
                                                <span className="px-2 py-1 bg-amber-100 dark:bg-amber-900/30 text-amber-800 dark:text-amber-400 rounded-full text-xs font-medium">Top Chef</span>
                                                <span className="px-2 py-1 bg-blue-100 dark:bg-blue-900/30 text-blue-800 dark:text-blue-400 rounded-full text-xs font-medium">Recipe Creator</span>
                                                <span className="px-2 py-1 bg-green-100 dark:bg-green-900/30 text-green-800 dark:text-green-400 rounded-full text-xs font-medium">Trendsetter</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                ...
                {activeTab === 'Recipes' && (
                    <div className="text-center py-8">
                        <h2 className="text-lg text-gray-700 dark:text-gray-300">User's recipes will be displayed here</h2>
                    </div>
                )}
                
                {activeTab === 'Followers' && (
                    <div className="text-center py-8">
                        <h2 className="text-lg text-gray-700 dark:text-gray-300">User's followers will be displayed here</h2>
                    </div>
                )}
                
                {activeTab === 'Following' && (
                    <div className="text-center py-8">
                        <h2 className="text-lg text-gray-700 dark:text-gray-300">Accounts this user follows will be displayed here</h2>
                    </div>
                )}
            </div>
        </div>
