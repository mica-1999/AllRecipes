        ...
        <footer>
            ...
            <div id="socialsSection" className="flex max-lg:flex-col max-lg:items-center justify-between bg-gray-100 w-full text-gray-800 dark:bg-gray-800 dark:text-white">
                <div className="flex flex-col w-[40%] max-lg:w-[80%] max-sm:px-0 p-13">
                    <h1 className="text-[1.25rem] font-semibold mb-5 text-gray-700 dark:text-gray-200">About Us</h1>
                    <p className="text-gray-600 dark:text-gray-400">RecipeHub is your go-to platform to discover, save, and share delicious recipes. Organize your favorites, explore new dishes, and connect with a community of food lovers. Start your culinary journey with us today!</p>
                ...
                <div className="flex flex-col w-[30%] max-lg:w-[80%] max-lg:pt-0 max-sm:px-0 p-13">
                    <h1 className="text-[1.25rem] font-semibold mb-5 text-gray-700 dark:text-gray-200">Contact Info</h1>
                    <div className="flex items-center gap-3">
                        <i className="ri-map-pin-line text-[#FF6B35]"></i>
                        <p className="text-gray-600 dark:text-gray-400">Canhas, Funchal, Madeira</p>
                    </div>
                ...
                <div className="flex flex-col w-[30%] p-13 max-lg:w-[80%] max-lg:pt-0 max-sm:px-0">
                    <h1 className="text-[1.25rem] font-semibold mb-5 text-gray-700 dark:text-gray-200">Quick Links</h1>
                    <div className="flex">
