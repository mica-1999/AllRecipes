    ...
    return (
        <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md dark:shadow-lg dark:shadow-black/20 border border-gray-100 dark:border-gray-700">
            <div className="flex items-center mb-4">
                ...
                <h2 className="text-xl font-semibold text-gray-800 dark:text-white">Cuisine Preferences</h2>
            </div>
            <p className="text-sm text-gray-600 dark:text-gray-400 mb-6">What types of cuisine do you prefer?</p>
