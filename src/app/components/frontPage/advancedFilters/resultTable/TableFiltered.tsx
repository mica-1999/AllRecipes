...
export default function TableFiltered({
    ...
    onResetFilters, searchQuery, setSearchQuery, sortField, setSortField,
    sortOrder, setSortOrder, startDate, setStartDate, endDate, setEndDate,
}: TableFilteredProps) {
    ...
    const fetchRecipes = useCallback(async () => {
        try {
            ...
            // Handle main filter menu options using switch
            switch (mainFilterMenu) {
                case "Seasonal":
            ...
            // Exact match parameters - only include if we have related filters
            if (dietaryRestrictions.length > 0) params.append('exactMatchDiet', exactMatchDiet.toString());
            if (ingredients.length > 0) params.append('exactMatchIngredients', exactMatchIngredients.toString());
            if (occasion.length > 0) params.append('exactMatchOccasion', exactMatchOccasion.toString());
            ...
            // Attach all parameters to the URL and fetch data
